...
`} />
  ...
  "4.1.3/gettingstarted--quickstart": () => (
...
`} />
  ...
  "4.1.3/gettingstarted--configuration": () => (
...
`} />
  ...
  "4.1.3/integrations--django--django": () => (
...
`} />
  ...
  "4.1.2/gettingstarted--installation": () => (
    <MarkdownRenderer content={`# Installation
...
`} />
  ...
  "4.1.2/gettingstarted--quickstart": () => (
    <MarkdownRenderer content={`# Quickstart
...
`} />
  ...
  "4.1.2/gettingstarted--configuration": () => (
    <MarkdownRenderer content={`# Configuration
...
`} />
  ...
  "4.1.2/integrations--django--django": () => (
    <MarkdownRenderer content={`# Django
...
`} />
  ...
  "4.1.1/gettingstarted--installation": () => (
    <MarkdownRenderer content={`# Installation
...
`} />
  ...
  "4.1.1/gettingstarted--quickstart": () => (
    <MarkdownRenderer content={`# Quickstart
...
`} />
  ...
  "4.1.1/gettingstarted--configuration": () => (
    <MarkdownRenderer content={`# Configuration
...
`} />
  ...
  "4.1.1/integrations--django--django": () => (
    <MarkdownRenderer content={`# Django
